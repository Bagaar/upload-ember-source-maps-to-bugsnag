...
const { config: readEnvFile } = require('dotenv');
const { bool, cleanEnv, str } = require('envalid');
const { existsSync, readdirSync, readFileSync, unlinkSync } = require('fs');
...
async function uploadEmberSourceMapsToBugsnag(args) {
...
module.exports = {
  uploadEmberSourceMapsToBugsnag,
};
